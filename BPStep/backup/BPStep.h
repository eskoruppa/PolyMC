...
protected:
    ...
    arma::mat*   M0_energy;    // Stiffness matrix in units of enery
    arma::mat    M0_energy_store;
    ...
    arma::mat zeromat;   // could be removed.
...
// member functions
public:
    BPStep(int id_in_chain, const std::string& full_seq, IDB& database, double discretization_length, double Temperature, bool closed);
    ~BPStep();
