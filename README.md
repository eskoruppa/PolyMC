...
- sigma: (default: 0)
    ...
    Supercoiling density $$\sigma = \Delta Lk / Lk_0 = (Lk - Lk_0) / Lk_0$$ 
of the intial configuration. Lk_0 is determined by the intrinsic  
...
- copy_input (default: 1)
    ...
    If set to 1 all input files are included in the outfiles specified by dump_dir. The input file will be generated by 
...
5. E. Skoruppa [DNA fluctuations reveal the size and dynamics of topological domains](https://doi.org/10.1093/pnasnexus/pgac268). *PNAS Nexus*, 1:pgac268, 2022
